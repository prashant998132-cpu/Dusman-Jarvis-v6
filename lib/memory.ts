// lib/memory.ts — JARVIS v7.0 (Fixed All Build Errors)
export const KEYS = {
  CHATS: 'jarvis_chats',
...
// ━━━ FUNCTIONS FOR BUILD ERRORS (Fixed) ━━━
...
export function getAllMemories(): MemoryEntry[] { return lsGet(KEYS.MEMORIES, []); }

export function getBadges(): Badge[] { return lsGet(KEYS.BADGES, []); }
...
export function exportAllData() { 
  const data = { profile: getProfile(), chats: getChats(), memories: getAllMemories() };
